    ...
    <div className="min-h-screen bg-slate-950 text-slate-50">
      <div className="mx-auto flex max-w-6xl flex-col gap-6 px-6 py-8">
        <header className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            <p className="text-xs uppercase tracking-widest text-indigo-300">Phase 5 – Advanced Planning</p>
            <h1 className="text-3xl font-semibold">Planning – vues V1 & PRO</h1>
            <p className="text-sm text-slate-300">Gérer les référentiels, la timeline V1 et préparer la timeline PRO V2.</p>
          </div>
          <nav className="flex flex-wrap gap-2">
            <NavLink to="/planning" className={navLinkClass}>
              Planning
            </NavLink>
            <NavLink to="/planning/pro" className={navLinkClass}>
              Planning PRO
            </NavLink>
