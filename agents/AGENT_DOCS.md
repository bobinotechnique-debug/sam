...
- Ouvrir et suivre la Phase 5 : conserver `docs/roadmap/phase-05.md` et les fichiers `docs/roadmap/phase5/step-XX.md` alignés avec le code/tests, et préparer la mise à jour des specs planning PRO.
